...
namespace AbpBoilerPlate.ObjectExtending
{
    public static class AbpBoilerPlateDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpBoilerPlateEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
