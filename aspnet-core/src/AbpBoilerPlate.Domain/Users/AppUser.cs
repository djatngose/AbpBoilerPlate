...
namespace AbpBoilerPlate.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpBoilerPlateDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpBoilerPlateEfCoreEntityExtensionMappings to extend the IdentityUser entity
